...
const source = {
  key: manifest.pipedream.sources.onStampNFT.slug,
  name: manifest.pipedream.sources.onStampNFT.alias,
  description:
    "Webhook entry point to export to PNG the NFT Ticket for Lootbox",
  version: "0.0.1",
  props: {
    httpInterface: {
      type: "$.interface.http",
