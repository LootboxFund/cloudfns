...
var gbucketUploadJSON = {
     ...
     */
        ...
        const { data, semvar, chainIdHex, prefix, bucket } = this
            .webhookTrigger.object;
        const filePath = `v/${semvar}/${chainIdHex}/${prefix}/${data.address}.json`;
        console.log(`⏳ Uploading ${data.symbol} to Cloud Storage Bucket as https://firebasestorage.googleapis.com/v0/b/${bucket}/o/${encodeURISafe(filePath)}?alt=media \n`);
...
module.exports = gbucketUploadJSON;
//# sourceMappingURL=gbucketUploadJSON.js.map
