...
const demo = async () => {
  ...
  const linkToImage = await generateSimpleTicket(tempLocalPath, {
    ...
    eventName: "POGGERS Epic Battle Royal",
    hostName: "Newton's Gaming Association",
  });
  console.log(`linkToImage = ${linkToImage}`);
};
demo();

// curl -X POST -H "secret: my_secret" -H "Content-Type: application/json" -d '{
//   "coverPhoto": "https://lexica-serve-encoded-images2.sharif.workers.dev/full_jpg/2f8a30cc-a1ae-475c-8b82-b91fd96316d7",
//   "teamName": "Big Boidem",
//   "themeColor": "#065535",
...
//     "https://uploads-ssl.webflow.com/63bd0f8e51e48f5336cc7adb/63c1b3446e8f58197256869a_download-removebg-preview%20(1)%201%20(Traced).png"
//   ]
// }' https://stamp-nft-0-7-2-demo-wpkp2xisuq-ue.a.run.app/stamp/new/simple
